...
const GrinchPoster = () => {
    return (
        <img src="https://img01.mgo-images.com/image/thumbnail/v2/content/1MV1ca3f097dd209568db5d4a36e429dbda.jpeg" alt="Grinch Poster"/>
        );
    }
// 5b
    ...
    const GrinchAll = () => {
        ...
        const DiceRoll = () => {
            ...
            */
            ...
            // 8d
        return <h1>{die1 && die2 === 1 ? "SNAKE EYES" : die1 + " &" + die2}</h1>
        }
